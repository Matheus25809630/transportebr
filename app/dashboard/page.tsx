...
export default function DashboardTransportadora() {
  ...
  // 1. Proteção de Rota e Monitoramento de Ofertas
  useEffect(() => {
    const unsubscribeAuth = onAuthStateChanged(auth, (currentUser) => {
      if (currentUser) {
        setUser(currentUser);
        console.log("Usuário logado:", currentUser.email);
        // Ouve apenas as cargas aguardando coleta para o Mural de Ofertas
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 flex flex-col">
      {/* HEADER DE NAVEGAÇÃO INDUSTRIAL [cite: 3356] */}
      ...
      <main className="max-w-7xl mx-auto w-full p-4 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* 1. VISÃO GERAL (METRICAS) [cite: 3262] */}
        ...
        {/* 2. MURAL DE OFERTAS (CENTRAL DE FRETES) [cite: 2594, 2704] */}
        <div className="lg:col-span-8">
          <div className="bg-white rounded-[40px] shadow-sm border border-slate-200 overflow-hidden">
            <div className="p-8 border-b border-slate-100 flex justify-between items-center">
              <h2 className="text-xl font-black uppercase italic italic">Mural de Ofertas</h2>
        ...
        {/* 3. COLUNA DE GESTÃO E FINANCEIRO [cite: 2597, 2892] */}
        <div className="lg:col-span-4 space-y-6">
          ...
          {/* EXTRATO FINANCEIRO (ACUMULADO 0.5%) [cite: 2357, 2872] */}
